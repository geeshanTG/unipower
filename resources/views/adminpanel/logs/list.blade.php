...
<x-app-layout>
    <x-slot name="header">
        ...
        <link rel="stylesheet" type="text/css" media="screen"
            href="{{ asset('public/back/css/datatable-buttons/buttons.bootstrap4.min.css') }}">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-7 col-md-7 col-lg-6">
                    <h1 class="page-title txt-color-blueDark">
                        ...
                        <font style=" font-size: 22px"> {{ __('Logs') }} </font> </span>
                    </h1>
                </div>
            </div>
                    ...
                    <div class="widget-body no-padding">
                        <div id="search-log-form" class="smart-form">
                            ...
                            <footer>
                                ...
                                <button name="reset" id="reset" type="button" class="btn btn-default">
                                    {{ __('clear') }}</button>
                            </footer>
                        </div>
                    </div>
