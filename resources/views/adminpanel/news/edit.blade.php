            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('save-news') }}" enctype="multipart/form-data" method="post" id="news-form" class="smart-form">
                        @csrf
                        @method('PUT')
                            <fieldset>
                                <div class="row">
                                    ...
                                    <section class="col col-4">
                                        ...
                                        <label class="input"><i class="icon-append fa fa-calendar"></i>
                                            <input type="text" id="news_date" name="news_date" value="{{ $data->news_date }}" class="datepicker" data-date-format='yyyy-mm-dd' placeholder="YYYY-MM-DD" data-parsley-type="date" required>
                                        </label>
                                    </section>
                                    <section class="col col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <section class="col col-2">
                                        <img id="preview-image-before-upload-image-2" src="@if(!empty($data->image_2)) ../storage/app/{{ $data->image_2 }} @else {{ asset('public/back/img/whitebg.jpg'); }} @endif" alt="preview image" style="max-height: 250px;">
                                    </section>
                                    <section class="col col-2">
                                    ...
                                    <section class="col col-2">
                                        <img id="preview-image-before-upload-image-3" src="@if(!empty($data->image_3)) ../storage/app/{{ $data->image_3 }} @else {{ asset('public/back/img/whitebg.jpg'); }} @endif" alt="preview image" style="max-height: 250px;">
                                    </section>
                                </div>
                                <div class="row">
                                    <section class="col col-2">
                                    ...
                                    <section class="col col-2">
                                        <img id="preview-image-before-upload-image-4" src="@if(!empty($data->image_4)) ../storage/app/{{ $data->image_4 }} @else {{ asset('public/back/img/whitebg.jpg'); }} @endif" alt="preview image" style="max-height: 250px;">
                                    </section>
                                </div>
                                <div class="row">
