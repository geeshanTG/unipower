        ...
        <div id="content">
            ...
            <div class="col-lg-12">
                    <div class="row cms_top_btn_row" style="margin-left:auto;margin-right:auto;">
                        ...
                        <a href="{{ route('sub-categories-list') }}">
                        ...
                        <div class="jarviswidget jarviswidget-color-darken" id="user_types" data-widget-editbutton="false">
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding table-responsive">
                                    <table class="table table-bordered data-table" width="100%" id="sub-categories-table">
                                        <thead>
                                            <tr>
                                                <th style="width: 5%;">{{ __('No') }}</th>
                                                <th style="width: 30%;">{{ __('Main Catgeory') }}</th>
                                                <th style="width: 30%;">{{ __('Sub Category Heading') }}</th>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                var table = $('.data-table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('sub-categories-list') }}",
                    order: [ 3, 'asc' ],
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'id'
                        ...
                        {
                            data: 'blocksubcategories',
                            name: 'blocksubcategories',
                            orderable: false,
                            searchable: false
                        },
                    ]
            ...
            $('#sub-categories-table').on('click', '.btn-delete', function(e) {
                ...
                swal({
                    ...
                    if (value == true) {
                        window.location.replace("blocksubcategories/" + id);
                    }
                });
            });
        </script>
