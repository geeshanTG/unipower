                ...
                <div class="col-lg-12">
                    <div class="row cms_top_btn_row" style="margin-left:auto;margin-right:auto;">
                        <a href="{{ route('new-category') }}">
                            <button class="btn cms_top_btn top_btn_height cms_top_btn_active">ADD NEW CATEGORY</button>
                        </a>

                        <a href="{{ route('category-list') }}">
                            <button class="btn cms_top_btn top_btn_height ">VIEW ALL CATEGORIES</button>
                        </a>
                    </div>
                </div>
                <!-- <div class="col-lg-8">
            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false"
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('save-category') }}" enctype="multipart/form-data" method="post"
                            id="store_details_form" class="smart-form">
                            @csrf
                            <fieldset>
                                <div class="row ">
                                ...
                                <div class="row ">
                                    ...
                                    <section class="col col-2">
                                        <img id="preview-image-before-upload-image"
                                            src="../storage/app/{{ $image }}" alt="preview image"
                                    ...
                                    <section class="col col-6">
                                        ...
                                        <label class="select">
                                            <select name="status" id="status">
                                                <option value="Y"
                                                    @if ($status == 'Y') selected="selected" @endif>Active
                                                </option>
                                                <option value="N"
                                                    @if ($status == 'N') selected="selected" @endif>
                                                    Inactive</option>
                                            </select>
                                            <i></i>
                                        </label>
                            ...
                            <footer>
                                @if ($savestatus != 'A')
                                    <input type="hidden" id="id" name="id"
                                        value="{{ encrypt($info[0]->id) }}" />
                                    <input type="hidden" id="adddressid" name="adddressid"
                                        value="{{ encrypt($info[0]->addressID) }}" />
                                @endif
