@section('title', 'Main Categories List')
                        ...
                        <div class="jarviswidget jarviswidget-color-darken" id="user_types" data-widget-editbutton="false">
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding table-responsive">
                                    <table class="table table-bordered data-table" width="100%" id="main-categories-table">
                                        <thead>
                                            <tr>
                                                <th style="width: 10%;">{{ __('No') }}</th>
                                                <th style="width: 30%;">{{ __('Heading') }}</th>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                var table = $('.data-table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('main-categories-list') }}",
                    order: [ 3, 'asc' ],
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'id'
                        ...
                        {
                            data: 'blockmaincategories',
                            name: 'blockmaincategories',
                            orderable: false,
                            searchable: false
                        },
                    ]
            ...
            $('#main-categories-table').on('click', '.btn-delete', function(e) {
                ...
                swal({
                    ...
                    if (value == true) {
                        window.location.replace("blockmaincategories/" + id);
                    }
                });
            });
        </script>
