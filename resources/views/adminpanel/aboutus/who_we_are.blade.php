                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    <section class="col col-2">
                                        <label class="label">{{ __('Image 1') }} (1920 x 1080) <span style=" color: red;">*</span></label>
                                        <label class="input">
                                    ...
                                    <section class="col col-2">
                                        <label class="label">{{ __('Image 2') }} (1920 x 1080) <span style=" color: red;">*</span></label>
                                        <label class="input">
                                    ...
                                    <section class="col col-2">
                                        <label class="label">{{ __('Image 3') }} (1920 x 1080) <span style=" color: red;">*</span></label>
                                        <label class="input">
