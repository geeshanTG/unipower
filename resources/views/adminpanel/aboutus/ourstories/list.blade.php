@section('title', 'Our Stories List')
...
<x-app-layout>
                        ...
                        <div class="jarviswidget jarviswidget-color-darken" id="user_types" data-widget-editbutton="false">
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding table-responsive">
                                    <table class="table table-bordered data-table" width="100%" id="our-stories-table">
                                        <thead>
                                            <tr>
                                                <th style="width: 10%;">{{ __('No') }}</th>
                                                <th style="width: 20%;">{{ __('Year') }}</th>
    ...
    <x-slot name="script">
        ...
        <script type="text/javascript">
            $(function() {
                ...
                var table = $('.data-table').DataTable({
                    ...
                    columns: [{
                        ...
                        {
                            data: 'blockourstories',
                            name: 'blockourstories',
                            orderable: false,
                            searchable: false
                        },
                    ]
            ...
            $('#our-stories-table').on('click', '.btn-delete', function(e) {
                ...
                swal({
                    ...
                    if (value == true) {
                        window.location.replace("blockourstories/" + id);
                    }
                });
            });
        </script>
