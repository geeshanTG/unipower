@section('title', 'Edit Our Stories')
<x-app-layout>
    <x-slot name="header">
            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('save-our-stories') }}" enctype="multipart/form-data" method="post" id="our-stories-form" class="smart-form">
                        @csrf
                        @method('PUT')
                            <fieldset>
                                <div class="row">
                                    ...
                                    <section class="col col-md-4">
                                        ...
                                        <label class="input"><i class="icon-append fa fa-calendar"></i>
                                            ...
                                            <input type="text" id="year" name="year" value="{{ $data->year }}" class="datepicker" data-date-format='yyyy-mm-dd' placeholder="YYYY-MM-DD" data-parsley-type="date" required>
                                        </label>
                                    </section>
                                    <section class="col col-md-4">
