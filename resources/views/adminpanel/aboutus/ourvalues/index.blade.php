                        ...
                        <div class="jarviswidget jarviswidget-color-darken" id="user_types" data-widget-editbutton="false">
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding table-responsive">
                                    <table class="table table-bordered data-table" width="100%" id="our-values-table">
                                        <thead>
                                            <tr>
                                                <th style="width: 15%;">{{ __('No') }}</th>
                                                <th style="width: 35%;">{{ __('Heading') }}</th>
                                                <th style="width: 20%;">{{ __('Icon') }}</th>
                                                <th style="width: 15%;">{{ __('Order') }}</th>
                                                <th style="width: 15%;">{{ __('Edit') }}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        </tbody>
