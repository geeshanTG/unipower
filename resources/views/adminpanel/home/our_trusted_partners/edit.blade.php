@section('title', 'Edit Our Trusted Partners')
<x-app-layout>
    <x-slot name="header">
    </x-slot>
    ...
    <div id="main" role="main">
        ...
        <div id="content">
            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
                <header>
                    <h2>{{ __('Edit Our Trusted Partners') }}</h2>
                </header>
                <!-- widget div-->
                <div>
                    <!-- widget edit box -->
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('save-our-trusted-partners') }}" enctype="multipart/form-data" method="post" id="our-trusted-partners-form" class="smart-form">
                        @csrf
                        @method('PUT')
                            <fieldset>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <section class="col col-3">
                                        <img id="preview-image-before-upload" src="@if(!empty($data->image)) ../storage/app/{{ $data->image }} @else {{ asset('public/back/img/whitebg.jpg'); }} @endif" alt="preview image" style="max-height: 250px;">
                                    </section>
                                </div>
                            </fieldset>
                            <footer>
    ...
    <x-slot name="script">
        ...
        <script>
            $(function(){
                $('#our-trusted-partners-form').parsley();
            });
        </script>
