            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('new-our-trusted-partners') }}" enctype="multipart/form-data" method="post" id="our-trusted-partners-form" class="smart-form">
                            @csrf
                            <fieldset>
                                <div class="row">
                                ...
                                <div class="row">
                                    <section class="col col-md-3">
                                        <label class="label">{{ __('Image') }} (150 x 150) <span style=" color: red;">*</span></label>
                                        <label class="input">
