@section('title', 'Our Trusted Partners List')
...
<x-app-layout>
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="jarviswidget jarviswidget-color-darken" id="user_types" data-widget-editbutton="false">
                            <header>
                                ...
                                <h2>{{ __('Our Trusted Partners List') }}</h2>
                            </header>
                            <!-- widget div-->
                            <div>
                                <!-- widget edit box -->
                                ...
                                <div class="widget-body no-padding table-responsive">
                                    <table class="table table-bordered data-table" width="100%" id="our-trusted-partners-table">
                                        <thead>
                                            <tr>
                                                <th style="width: 10%;">{{ __('No') }}</th>
                                                <th style="width: 30%;">{{ __('Logo') }}</th>
    ...
    <x-slot name="script">
        ...
        <script type="text/javascript">
            $(function() {
                ...
                var table = $('.data-table').DataTable({
                    ...
                    columns: [{
                        ...
                        {
                            data: 'blockourtrustedpartners',
                            name: 'blockourtrustedpartners',
                            orderable: false,
                            searchable: false
                        },
                    ]
            ...
            $('#our-trusted-partners-table').on('click', '.btn-delete', function(e) {
                ...
                swal({
                    ...
                    if (value == true) {
                        window.location.replace("blockourtrustedpartners/" + id);
                    }
                });
            });
        </script>
