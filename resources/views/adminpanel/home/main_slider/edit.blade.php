                        ...
                        @method('PUT')
                            <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <section class="col col-2">
                                        <img id="preview-image-before-upload-icon" src="../storage/app/{{ $data->icon }}" alt="preview image" style="max-height: 250px; background-color: #000000;">
                                    </section>
                                    <section class="col col-2">
                                        <label class="label">{{ __('Desktop Image') }} (1920 x 1080)</label>
                                        <label class="input">
                                            <input type="file" class="form-control form-input" id="desktop_image" name="desktop_image" style="overflow: hidden;">
                                        </label>
                                    </section>
                                    <section class="col col-2">
                                        <img id="preview-image-before-upload-image-desktop" src="@if(!empty($data->desktop_image)) ../storage/app/{{ $data->desktop_image }} @else {{ asset('public/back/img/whitebg.jpg'); }} @endif" alt="preview image" style="max-height: 250px;">
                                    </section>
                                    <section class="col col-2">
                                        <label class="label">{{ __('Mobile Image') }} (1080 x 1920)</label>
                                        <label class="input">
                                            <input type="file" class="form-control form-input" id="mobile_image" name="mobile_image" style="overflow: hidden;">
                                        </label>
                                    </section>
                                    <section class="col col-2">
                                        <img id="preview-image-before-upload-image-mobile" src="@if(!empty($data->mobile_image)) ../storage/app/{{ $data->mobile_image }} @else {{ asset('public/back/img/whitebg.jpg'); }} @endif" alt="preview image" style="max-height: 250px;">
                                    </section>
                                </div>
                            </fieldset>
                            <footer>
