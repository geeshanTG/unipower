...
<x-app-layout>
                        ...
                        <div class="jarviswidget jarviswidget-color-darken" id="user_types" data-widget-editbutton="false">
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding table-responsive">
                                    <table class="table table-bordered data-table" width="100%" id="services-table">
                                        <thead>
                                            <tr>
                                                <th style="width: 10%;">{{ __('No') }}</th>
                                                <th style="width: 20%;">{{ __('Heading') }}</th>
                                                <th style="width: 30%;">{{ __('Short Description') }}</th>
    ...
    <x-slot name="script">
        ...
        <script type="text/javascript">
            ...
            $('#services-table').on('click', '.btn-delete', function(e) {
                ...
                swal({
                    ...
                    if (value == true) {
                        window.location.replace("blockservices/" + id);
                    }
                });
            });
        </script>
