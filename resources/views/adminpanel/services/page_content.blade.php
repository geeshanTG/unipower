...
<x-app-layout>
    ...
    <div id="main" role="main">
        ...
        <div id="content">
            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
                <header>
                    <h2>{{ __('Services Page Content') }}</h2>
                </header>
                <!-- widget div-->
                <div>
                    <!-- widget edit box -->
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('save-service-page-content') }}" enctype="multipart/form-data" method="post" id="services-page-content-form" class="smart-form">
                        @csrf
                        @method('PUT')
                            <fieldset>
                                <div class="row">
    ...
    <x-slot name="script">
        ...
        <script>
            $(function(){
                $('#services-page-content-form').parsley();
            });
