            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('save-services') }}" enctype="multipart/form-data" method="post" id="service-form" class="smart-form">
                        @csrf
                        @method('PUT')
                            <fieldset>
                                <div class="row">
                                    ...
                                    <section class="col col-md-4">
                                        ...
                                        <label class="input">
                                            <textarea class="form-control" id="short_description" name="short_description" rows="2" maxlength="80" required>{{ $data->short_description }}</textarea>
                                        </label>
                                    </section>
                                    <section class="col col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <section class="col col-2">
                                        <img id="preview-image-before-upload-image-4" src="../storage/app/{{ $data->image_4 }}" alt="preview image" style="max-height: 250px;">
                                    </section>
                                    <section class="col col-2">
                                    ...
                                    <section class="col col-2">
                                        <img id="preview-image-before-upload-image-5" src="../storage/app/{{ $data->image_5 }}" alt="preview image" style="max-height: 250px;">
                                    </section>
                                    <section class="col col-2">
                                    ...
                                    <section class="col col-2">
                                        <img id="preview-image-before-upload-image-6" src="../storage/app/{{ $data->image_6 }}" alt="preview image" style="max-height: 250px;">
                                    </section>
                                </div>
                                <div class="row">
                                    <section class="col col-md-11"  style="width: 100%;">
                                        ...
                                        <label class="input">
                                            <textarea class="form-control summernote" id="long_description" name="long_description" rows="2" required>{{ $data->long_description }}</textarea>
                                        </label>
                                    </section>
                                </div>
                            </fieldset>
