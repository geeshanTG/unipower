            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('new-services') }}" enctype="multipart/form-data" method="post" id="services-form" class="smart-form">
                            @csrf
                            <fieldset>
                                <div class="row">
                                    ...
                                    <section class="col col-md-4">
                                        <label class="label">{{ __('Short Description (Max character count limit is 80)') }}<span style=" color: red;">*</span> </label>
                                        <label class="input">
                                            <textarea class="form-control" id="short_description" name="short_description" rows="2" maxlength="80" required></textarea>
                                        </label>
                                    </section>
                                    <section class="col col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <section class="col col-md-2">
                                        <label class="label">{{ __('Image 2') }} (1200 x 800) <span style=" color: red;">*</span></label>
                                        <label class="input">
                                            <input type="file" class="form-control form-input" id="image_2" name="image_2" style="overflow: hidden;" required>
                                        </label>
                                    </section>
                                    <section class="col col-md-2">
                                    ...
                                    <section class="col col-md-2">
                                        ...
                                        <label class="input">
                                            <input type="file" class="form-control form-input" id="image_3" name="image_3" style="overflow: hidden;" required>
                                        </label>
                                    </section>
                                    <section class="col col-md-2">
                                ...
                                <div class="row">
                                    ...
                                    <section class="col col-md-2">
                                        <label class="label">{{ __('Image 5') }} (1200 x 800) </label>
                                        <label class="input">
                                            <input type="file" class="form-control form-input" id="image_5" name="image_5" style="overflow: hidden;">
                                        </label>
                                    </section>
                                    <section class="col col-md-2">
                                        <img id="preview-image-before-upload-image-5" src="{{ asset('public/back/img/whitebg.jpg'); }}" alt="preview image" style="max-height: 250px;">
                                    </section>
                                    <section class="col col-md-2">
                                        <label class="label">{{ __('Image 6') }} (1200 x 800)</label>
                                        <label class="input">
                                            <input type="file" class="form-control form-input" id="image_6" name="image_6" style="overflow: hidden;">
                                        </label>
                                    </section>
                                    <section class="col col-md-2">
                                        <img id="preview-image-before-upload-image-6" src="{{ asset('public/back/img/whitebg.jpg'); }}" alt="preview image" style="max-height: 250px;">
                                    </section>
                                </div>
                                <div class="row">
                                    <section class="col col-md-11"  style="width: 100%;">
                                        ...
                                        <label class="input">
                                            <textarea class="form-control summernote" id="long_description" name="long_description" rows="2" required></textarea>
                                        </label>
                                    </section>
                                </div>
                            </fieldset>
            ...
            $(document).ready(function(e) {
                ...
                $('#image_5').change(function() {
                    ...
                    reader.onload = (e) => {
                        ...
                        $('#preview-image-before-upload-image-5').attr('src', e.target.result);
                    }
                ...
                $('#image_6').change(function() {
                    ...
                    reader.onload = (e) => {
                        ...
                        $('#preview-image-before-upload-image-6').attr('src', e.target.result);
                    }
